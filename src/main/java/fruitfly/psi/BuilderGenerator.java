...
public class BuilderGenerator {
    ...
    public static void generateBuilderPattern(
        ...
        final var builderClass = recordClass.addBefore(
            ...
            endOfClass);
        final var butMethod = recordClass.addBefore(
            createButMethod(recordClass, selectedFields),
            builderClass);
        final var builderMethod = recordClass.addBefore(
   ...
   /* It seems the createClassFromText() method generates a _Dummy_ parent
    ...
    public static PsiMethod createBuilderMethod(
        ...
        // Builder class
        final var text = "public static Builder builder() {" +
            "return new Builder();" +
            "}";
