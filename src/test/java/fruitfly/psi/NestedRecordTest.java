...
public class NestedRecordTest extends FruitflyTestCase {
    ...
    public void testNested() {
        var inputJava = getTestPsiJavaFile("fruitfly/psi/nested_record/NestedRecordTestInput.java");
        var outputText = getTestPsiTextFile("fruitfly/psi/nested_record/NestedRecordTestOutput.txt");
